...
export const StudentCard = ({
  ...
  // Contagem de quantos módulos esse aluno já concluiu
  ...
  <div className="group relative overflow-hidden rounded-3xl bg-white/5 p-6 shadow-soft ring-1 ring-white/10 backdrop-blur transition hover:bg-white/7">
    {/* Glow sutil no hover */}
    <div className="pointer-events-none absolute -top-24 -right-24 h-56 w-56 rounded-full bg-brand-pink/15 blur-3xl opacity-0 transition group-hover:opacity-100" />
    ...
    <div className="flex gap-3">
      ...
      <Link
        ...
        className="inline-flex flex-1 items-center justify-center rounded-2xl bg-white/5 px-4 py-3 text-sm font-bold text-white/85 ring-1 ring-white/15 transition hover:bg-white/10 active:bg-white/15"
